...
public class xw1h extends AppCompatActivity {
    ...
    String[] i = new String[]{
            ...
            "98%","97%","96%","95%","94%","93%","92%","91%","90%","89%","88%","87%","86%","85%","84%","83%","82%","81%","80%","79%","78%","77%","76%","75%","74%","73%","72%","71%","70%","69%","68%","67%","66%","65%","64%","63%","62%","61%","60%","59%","58%","57%","56%","55%","54%","53%","52%",
            "52%","53%","54%"
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_xw1h);
...
//                mediaPlayer2=MediaPlayer.create(MainActivity.this, R.raw.satalite);//读取视频
                mediaPlayer2=MediaPlayer.create(xw1h.this, R.raw.xw1h);
                ...
                mediaPlayer1.reset();
                mediaPlayer1=MediaPlayer.create(xw1h.this, R.raw.dxw1h);//读取视频
