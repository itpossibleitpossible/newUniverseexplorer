...
public class gjkj extends Activity {
    ...
    String[] i = new String[]{
            ...
            "93%","92%","91%","90%","89%","88%","87%","86%","85%","84%","83%","82%","81%","80%","79%","78%","77%","76%","75%","74%","73%","72%","71%","70%","69%","68%","67%","66%","65%","64%","63%",
            "63%","64%","65%","66%","67%","68%","69%","7%0","71%","72%","73%","74%","75%","76%","77%","78%","79%","80%","81%","82%","83%","84%","85%","86%","87%","88%","89%","90%",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gjkj);
...
//                mediaPlayer2=MediaPlayer.create(MainActivity.this, R.raw.satalite);//读取视频
                mediaPlayer2=MediaPlayer.create(gjkj.this, R.raw.gjkj);
                ...
                mediaPlayer1.reset();
                mediaPlayer1=MediaPlayer.create(gjkj.this, R.raw.dgjkj);//读取视频
