...
public class gdxx extends AppCompatActivity {
    WebView webView;
    Button fh, syy;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(gdxx.this, "正在加载中，请耐心等待",Toast.LENGTH_LONG).show();
        ...
        webView.loadUrl("https://baike.so.com/doc/5719260-5931987.html");             //加载外网
        webView.setWebViewClient(new gdxx.HelloWebViewClient());

        Toast.makeText(gdxx.this, "加载成功",Toast.LENGTH_SHORT).show();

        fh.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(gdxx.this, MainActivity.class);
