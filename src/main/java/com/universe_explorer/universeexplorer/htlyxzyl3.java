...
public class htlyxzyl3 extends AppCompatActivity {
    RadioGroup daan;
    Button syt,ckda,xyt;
    int yourchoice=-1;
    RadioButton A,B,C,D;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_htlyxzyl3);
        ...
        syt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(htlyxzyl3.this,htlyxzyl2.class);
        ...
        ckda.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (yourchoice==-1)
                    Toast.makeText(htlyxzyl3.this,"请答题",Toast.LENGTH_SHORT).show();
        ...
        xyt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(htlyxzyl3.this,htlyxzyl4.class);
                startActivity(intent);
                finish();
            }
        });
    ...
    private void showturedialog()
    {
        ...
        builder.setTitle("解析")
                ...
                .setMessage("正确。在地球赤道或低纬度地区发射地球静止卫星，可以减少发射航天器所需能量，缩短发射点到入轨点的航程。")
    ...
    private void showfalsedialog()
    {
        ...
        builder.setTitle("解析")
                .setIcon(R.drawable.dialoglogo)
                .setMessage("错误,正确答案为D。在地球赤道或低纬度地区发射地球静止卫星，可以减少发射航天器所需能量，缩短发射点到入轨点的航程。")
                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
