...
public class fy2c extends AppCompatActivity {
    ...
    String[] i = new String[]{
            ...
            "94%","93%","92%","91%","90%","89%","88%","87%","86%","85%","84%","83%","82%","81%","80%","79%","78%","77%","76%","75%","74%","73%","72%","71%","70%","69%","68%","67%","66%","65%","64%","63%","62%","61%","60%","59%","58%","57%","56%","55%","54%","53%","53%","51%","50%",
            "50%","51%","52%"
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fy2c);
...
//                mediaPlayer2=MediaPlayer.create(MainActivity.this, R.raw.satalite);//读取视频
                mediaPlayer2=MediaPlayer.create(fy2c.this, R.raw.fy2c);
                ...
                mediaPlayer1.reset();
                mediaPlayer1=MediaPlayer.create(fy2c.this, R.raw.dfy2c);//读取视频
