...
public class tgeh extends AppCompatActivity {
    ...
    String[] i = new String[]{
            ...
            "98%","97%","96%","95%","94%","93%","92%","91%","90%","89%","88%","87%","86%","85%","84%","83%","82%","81%","80%","79%","78%","77%","76%","75%","74%","73%","72%","71%","70%","69%","68%","67%","66%","65%","64%","63%","62%","61%","60%","59%","58%",
            "58%","59%","60%","61%","62%"
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tgeh);
...
//                mediaPlayer2=MediaPlayer.create(MainActivity.this, R.raw.satalite);//读取视频
                mediaPlayer2=MediaPlayer.create(tgeh.this, R.raw.tgeh);
                ...
                mediaPlayer1.reset();
                mediaPlayer1=MediaPlayer.create(tgeh.this, R.raw.dtgrh);//读取视频
