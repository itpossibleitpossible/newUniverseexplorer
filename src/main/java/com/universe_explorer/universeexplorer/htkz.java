...
public class htkz extends AppCompatActivity {
    WebView webView;
    Button fh, syy;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(htkz.this, "正在加载中，请耐心等待",Toast.LENGTH_LONG).show();
        ...
        webView.loadUrl("https://baike.so.com/doc/9534376-9878775.html");             //加载外网
        webView.setWebViewClient(new htkz.HelloWebViewClient());

        Toast.makeText(htkz.this, "加载成功",Toast.LENGTH_SHORT).show();

        fh.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(htkz.this, MainActivity.class);
